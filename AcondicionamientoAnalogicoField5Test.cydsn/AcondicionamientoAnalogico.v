...
module top ;
    ...
    Analog_LPF_v1_0_10 LPF_2 (
        .Vin(Net_7100),
        .Vout(Net_4204));

    OpAmp_v1_90_11 OPAref (
        .Vminus(Net_7101),
        .Vout(Net_4661),
        .Vplus(Net_4204));
