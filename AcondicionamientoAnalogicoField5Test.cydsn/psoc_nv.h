 ...
 *
 * Layout EEPROM v3 (1 fila de 16 bytes por ganancia PGA 0..8):
 *   [0] magic, [1] version, [2] hw_class, [3] pga_code, [4] stage_count,
 *   [5] valid_mask, [6..9] cal_dac[4], [10] sign_mask,
 *   [11] pgaout_code, [12..13] reserved, [14..15] crc_le.
 */

#include "project.h"

#define PSOC_NV_MAGIC        0xCAu
#define PSOC_NV_VERSION      0x03u
...
/* Devuelve la ganancia PGAout que pertenece al mismo registro v3. El arranque
 * la aplica antes de cargar los DAC: los códigos de una calibración x24 no son
 * seguros ni correctos con PGAout x1. */
uint8 psoc_nv_load_pgaout_for_gain(uint8 pga_code, uint8 *pgaout_code,
                                  uint8 cal_count);
