// ======================================================================
// DiferencialConRrefsYMux_Copy_01.v generated from TopDesign.cysch
// 05/15/2026 at 21:29
...
// OpAmp_v1_90(Mode=0, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opa_VDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opa_VDAC, CY_INSTANCE_SHORT_NAME=Opa_VDAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Opa_VDAC, )
...
// TIA_v2_0(Capacitive_Feedback=3, Fcorner=277 kHz, Power=3, Resistive_Feedback=4, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TIA_v2_0, CY_CONFIG_TITLE=TIA_p_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIA_p_1, CY_INSTANCE_SHORT_NAME=TIA_p_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=TIA_p_1, )
module TIA_v2_0_4 (
    Iin,
    Vout,
    Vref);
...
module top ;
	...
	wire [0:0] tmpOE__Vref_2_net;
	wire [0:0] tmpFB_0__Vref_2_net;
	wire [0:0] tmpIO_0__Vref_2_net;
	wire [0:0] tmpINTERRUPT_0__Vref_2_net;
	electrical [0:0] tmpSIOVREF__Vref_2_net;

	cy_psoc3_pins_v1_10
		#(.id("3f56228d-17d5-425f-b40f-065dfdbfec9e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Vref_2
		 (.oe(tmpOE__Vref_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Vref_2_net[0:0]}),
		  .analog({Vcomun}),
		  .io({tmpIO_0__Vref_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Vref_2_net),
		  .interrupt({tmpINTERRUPT_0__Vref_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Vref_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Opa_diff_out_net;
	wire [0:0] tmpFB_0__Opa_diff_out_net;
	wire [0:0] tmpIO_0__Opa_diff_out_net;
	wire [0:0] tmpINTERRUPT_0__Opa_diff_out_net;
	electrical [0:0] tmpSIOVREF__Opa_diff_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Opa_diff_out
		 (.oe(tmpOE__Opa_diff_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Opa_diff_out_net[0:0]}),
		  .analog({Net_1890}),
		  .io({tmpIO_0__Opa_diff_out_net[0:0]}),
		  .siovref(tmpSIOVREF__Opa_diff_out_net),
		  .interrupt({tmpINTERRUPT_0__Opa_diff_out_net[0:0]}),
		  .annotation({Net_1927}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Opa_diff_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Opa_diff_vp_net;
	wire [0:0] tmpFB_0__Opa_diff_vp_net;
	wire [0:0] tmpIO_0__Opa_diff_vp_net;
	wire [0:0] tmpINTERRUPT_0__Opa_diff_vp_net;
	electrical [0:0] tmpSIOVREF__Opa_diff_vp_net;

	cy_psoc3_pins_v1_10
		#(.id("311cfb33-9ed8-4fc5-8de6-0677836c896f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Opa_diff_vp
		 (.oe(tmpOE__Opa_diff_vp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Opa_diff_vp_net[0:0]}),
		  .analog({Net_1889}),
		  .io({tmpIO_0__Opa_diff_vp_net[0:0]}),
		  .siovref(tmpSIOVREF__Opa_diff_vp_net),
		  .interrupt({tmpINTERRUPT_0__Opa_diff_vp_net[0:0]}),
		  .annotation({Net_1901}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Opa_diff_vp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Opa_diff_vm_net;
	wire [0:0] tmpFB_0__Opa_diff_vm_net;
	wire [0:0] tmpIO_0__Opa_diff_vm_net;
	wire [0:0] tmpINTERRUPT_0__Opa_diff_vm_net;
	electrical [0:0] tmpSIOVREF__Opa_diff_vm_net;

	cy_psoc3_pins_v1_10
		#(.id("92d63d66-f064-42b9-98c8-0a1b65b10c3f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Opa_diff_vm
		 (.oe(tmpOE__Opa_diff_vm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Opa_diff_vm_net[0:0]}),
		  .analog({Net_1891}),
		  .io({tmpIO_0__Opa_diff_vm_net[0:0]}),
		  .siovref(tmpSIOVREF__Opa_diff_vm_net),
		  .interrupt({tmpINTERRUPT_0__Opa_diff_vm_net[0:0]}),
		  .annotation({Net_1907}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Opa_diff_vm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_v1_90_0 Opa_diff (
        .Vminus(Net_1891),
        .Vout(Net_1890),
        .Vplus(Net_1889));
    defparam Opa_diff.Mode = 0;
    ...
    OpAmp_v1_90_2 Opa_VDAC (
        .Vminus(Net_1971),
        .Vout(Net_1972),
        .Vplus(Net_1998));
    defparam Opa_VDAC.Mode = 0;

	wire [0:0] tmpOE__PGA_p_out_net;
	wire [0:0] tmpFB_0__PGA_p_out_net;
	wire [0:0] tmpIO_0__PGA_p_out_net;
	wire [0:0] tmpINTERRUPT_0__PGA_p_out_net;
	electrical [0:0] tmpSIOVREF__PGA_p_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("96e1fc5a-2f34-41fa-a7c0-2dbb16f71950"),
		  ...
		  .input_buffer_sel(2'b00))
		PGA_p_out
		 (.oe(tmpOE__PGA_p_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PGA_p_out_net[0:0]}),
		  .analog({Net_1124}),
		  .io({tmpIO_0__PGA_p_out_net[0:0]}),
		  .siovref(tmpSIOVREF__PGA_p_out_net),
		  .interrupt({tmpINTERRUPT_0__PGA_p_out_net[0:0]}),
		  .annotation({Net_1373}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PGA_p_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BPin_vp_net;
	wire [0:0] tmpFB_0__BPin_vp_net;
	wire [0:0] tmpIO_0__BPin_vp_net;
	wire [0:0] tmpINTERRUPT_0__BPin_vp_net;
	electrical [0:0] tmpSIOVREF__BPin_vp_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6d07625d-b357-4a56-8935-e53baaac1c7e"),
		  ...
		  .input_buffer_sel(2'b00))
		BPin_vp
		 (.oe(tmpOE__BPin_vp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BPin_vp_net[0:0]}),
		  .analog({Net_1930}),
		  .io({tmpIO_0__BPin_vp_net[0:0]}),
		  .siovref(tmpSIOVREF__BPin_vp_net),
		  .interrupt({tmpINTERRUPT_0__BPin_vp_net[0:0]}),
		  .annotation({Net_1940}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BPin_vp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PGA_n_out_net;
	wire [0:0] tmpFB_0__PGA_n_out_net;
	wire [0:0] tmpIO_0__PGA_n_out_net;
	wire [0:0] tmpINTERRUPT_0__PGA_n_out_net;
	electrical [0:0] tmpSIOVREF__PGA_n_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1b4e2062-0994-4203-a477-a3f0be60d4e1"),
		  ...
		  .input_buffer_sel(2'b00))
		PGA_n_out
		 (.oe(tmpOE__PGA_n_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PGA_n_out_net[0:0]}),
		  .analog({Net_1123}),
		  .io({tmpIO_0__PGA_n_out_net[0:0]}),
		  .siovref(tmpSIOVREF__PGA_n_out_net),
		  .interrupt({tmpINTERRUPT_0__PGA_n_out_net[0:0]}),
		  .annotation({Net_1832}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PGA_n_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OpaVDAC_out_net;
	wire [0:0] tmpFB_0__OpaVDAC_out_net;
	wire [0:0] tmpIO_0__OpaVDAC_out_net;
	wire [0:0] tmpINTERRUPT_0__OpaVDAC_out_net;
	electrical [0:0] tmpSIOVREF__OpaVDAC_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c8003c6-e9bf-4a22-9b4a-7f4148d73199"),
		  ...
		  .input_buffer_sel(2'b00))
		OpaVDAC_out
		 (.oe(tmpOE__OpaVDAC_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpaVDAC_out_net[0:0]}),
		  .analog({Net_1972}),
		  .io({tmpIO_0__OpaVDAC_out_net[0:0]}),
		  .siovref(tmpSIOVREF__OpaVDAC_out_net),
		  .interrupt({tmpINTERRUPT_0__OpaVDAC_out_net[0:0]}),
		  .annotation({Net_1948}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__OpaVDAC_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TIA_vp_net;
	wire [0:0] tmpFB_0__TIA_vp_net;
	wire [0:0] tmpIO_0__TIA_vp_net;
	wire [0:0] tmpINTERRUPT_0__TIA_vp_net;
	electrical [0:0] tmpSIOVREF__TIA_vp_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("de2b9c57-3b09-4d30-b6db-18e5b7929e49"),
		  ...
		  .input_buffer_sel(2'b00))
		TIA_vp
		 (.oe(tmpOE__TIA_vp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TIA_vp_net[0:0]}),
		  .analog({Net_1963}),
		  .io({tmpIO_0__TIA_vp_net[0:0]}),
		  .siovref(tmpSIOVREF__TIA_vp_net),
		  .interrupt({tmpINTERRUPT_0__TIA_vp_net[0:0]}),
		  .annotation({Net_1942}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__TIA_vp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__BPin_vm_net;
	wire [0:0] tmpFB_0__BPin_vm_net;
	wire [0:0] tmpIO_0__BPin_vm_net;
	wire [0:0] tmpINTERRUPT_0__BPin_vm_net;
	electrical [0:0] tmpSIOVREF__BPin_vm_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("11268be6-e82b-4a3c-a773-58d27b1e7e5e"),
		  ...
		  .input_buffer_sel(2'b00))
		BPin_vm
		 (.oe(tmpOE__BPin_vm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BPin_vm_net[0:0]}),
		  .analog({Net_1928}),
		  .io({tmpIO_0__BPin_vm_net[0:0]}),
		  .siovref(tmpSIOVREF__BPin_vm_net),
		  .interrupt({tmpINTERRUPT_0__BPin_vm_net[0:0]}),
		  .annotation({Net_1938}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BPin_vm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam VDAC.Initial_Value = 156;
	...
	wire [0:0] tmpOE__BPout_net;
	wire [0:0] tmpFB_0__BPout_net;
	wire [0:0] tmpIO_0__BPout_net;
	wire [0:0] tmpINTERRUPT_0__BPout_net;
	electrical [0:0] tmpSIOVREF__BPout_net;
	...
	cy_psoc3_pins_v1_10
		...
		BPout
		 (.oe(tmpOE__BPout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BPout_net[0:0]}),
		  .analog({Net_1929}),
		  .io({tmpIO_0__BPout_net[0:0]}),
		  .siovref(tmpSIOVREF__BPout_net),
		  .interrupt({tmpINTERRUPT_0__BPout_net[0:0]}),
		  .annotation({Net_1931}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BPout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__TIA_vm_net;
	wire [0:0] tmpFB_0__TIA_vm_net;
	wire [0:0] tmpIO_0__TIA_vm_net;
	wire [0:0] tmpINTERRUPT_0__TIA_vm_net;
	electrical [0:0] tmpSIOVREF__TIA_vm_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3fde1f9b-8262-4d24-a0cd-27c32cc9ef2a"),
		  ...
		  .input_buffer_sel(2'b00))
		TIA_vm
		 (.oe(tmpOE__TIA_vm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TIA_vm_net[0:0]}),
		  .analog({Net_1934}),
		  .io({tmpIO_0__TIA_vm_net[0:0]}),
		  .siovref(tmpSIOVREF__TIA_vm_net),
		  .interrupt({tmpINTERRUPT_0__TIA_vm_net[0:0]}),
		  .annotation({Net_1935}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__TIA_vm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__TIAout_net;
	wire [0:0] tmpFB_0__TIAout_net;
	wire [0:0] tmpIO_0__TIAout_net;
	wire [0:0] tmpINTERRUPT_0__TIAout_net;
	electrical [0:0] tmpSIOVREF__TIAout_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0b740478-9e54-4120-9bf2-d02741c863a9"),
		  ...
		  .input_buffer_sel(2'b00))
		TIAout
		 (.oe(tmpOE__TIAout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TIAout_net[0:0]}),
		  .analog({Net_1932}),
		  .io({tmpIO_0__TIAout_net[0:0]}),
		  .siovref(tmpSIOVREF__TIAout_net),
		  .interrupt({tmpINTERRUPT_0__TIAout_net[0:0]}),
		  .annotation({Net_1933}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__TIAout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__VDACout_net;
	wire [0:0] tmpFB_0__VDACout_net;
	wire [0:0] tmpIO_0__VDACout_net;
	wire [0:0] tmpINTERRUPT_0__VDACout_net;
	electrical [0:0] tmpSIOVREF__VDACout_net;

	cy_psoc3_pins_v1_10
		#(.id("5c5b67f4-ba94-4e31-b4ba-eff462502618"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VDACout
		 (.oe(tmpOE__VDACout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VDACout_net[0:0]}),
		  .analog({Net_1945}),
		  .io({tmpIO_0__VDACout_net[0:0]}),
		  .siovref(tmpSIOVREF__VDACout_net),
		  .interrupt({tmpINTERRUPT_0__VDACout_net[0:0]}),
		  .annotation({Net_1983}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__VDACout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OpaVDAC_vm_net;
	wire [0:0] tmpFB_0__OpaVDAC_vm_net;
	wire [0:0] tmpIO_0__OpaVDAC_vm_net;
	wire [0:0] tmpINTERRUPT_0__OpaVDAC_vm_net;
	electrical [0:0] tmpSIOVREF__OpaVDAC_vm_net;

	cy_psoc3_pins_v1_10
		#(.id("9020df99-7dc4-4a21-a1bf-ec09a9c0743a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OpaVDAC_vm
		 (.oe(tmpOE__OpaVDAC_vm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpaVDAC_vm_net[0:0]}),
		  .analog({Net_1971}),
		  .io({tmpIO_0__OpaVDAC_vm_net[0:0]}),
		  .siovref(tmpSIOVREF__OpaVDAC_vm_net),
		  .interrupt({tmpINTERRUPT_0__OpaVDAC_vm_net[0:0]}),
		  .annotation({Net_1991}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__OpaVDAC_vm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OpaVDAC_vp_net;
	wire [0:0] tmpFB_0__OpaVDAC_vp_net;
	wire [0:0] tmpIO_0__OpaVDAC_vp_net;
	wire [0:0] tmpINTERRUPT_0__OpaVDAC_vp_net;
	electrical [0:0] tmpSIOVREF__OpaVDAC_vp_net;

	cy_psoc3_pins_v1_10
		#(.id("37b72982-0d7c-4e61-b7e2-308ee74c1040"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		OpaVDAC_vp
		 (.oe(tmpOE__OpaVDAC_vp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpaVDAC_vp_net[0:0]}),
		  .analog({Net_1998}),
		  .io({tmpIO_0__OpaVDAC_vp_net[0:0]}),
		  .siovref(tmpSIOVREF__OpaVDAC_vp_net),
		  .interrupt({tmpINTERRUPT_0__OpaVDAC_vp_net[0:0]}),
		  .annotation({Net_1985}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__OpaVDAC_vp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OpaLP_vp_net;
	wire [0:0] tmpFB_0__OpaLP_vp_net;
	wire [0:0] tmpIO_0__OpaLP_vp_net;
	wire [0:0] tmpINTERRUPT_0__OpaLP_vp_net;
	electrical [0:0] tmpSIOVREF__OpaLP_vp_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5a7679c1-e5d8-4fb5-b328-51d0165a3555"),
		  ...
		  .input_buffer_sel(2'b00))
		OpaLP_vp
		 (.oe(tmpOE__OpaLP_vp_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpaLP_vp_net[0:0]}),
		  .analog({Net_2002}),
		  .io({tmpIO_0__OpaLP_vp_net[0:0]}),
		  .siovref(tmpSIOVREF__OpaLP_vp_net),
		  .interrupt({tmpINTERRUPT_0__OpaLP_vp_net[0:0]}),
		  .annotation({Net_2003}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__OpaLP_vp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OpaLP_vm_net;
	wire [0:0] tmpFB_0__OpaLP_vm_net;
	wire [0:0] tmpIO_0__OpaLP_vm_net;
	wire [0:0] tmpINTERRUPT_0__OpaLP_vm_net;
	electrical [0:0] tmpSIOVREF__OpaLP_vm_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a8e741cb-52da-4eb1-8013-3a9f7793e90a"),
		  ...
		  .input_buffer_sel(2'b00))
		OpaLP_vm
		 (.oe(tmpOE__OpaLP_vm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpaLP_vm_net[0:0]}),
		  .analog({Net_2000}),
		  .io({tmpIO_0__OpaLP_vm_net[0:0]}),
		  .siovref(tmpSIOVREF__OpaLP_vm_net),
		  .interrupt({tmpINTERRUPT_0__OpaLP_vm_net[0:0]}),
		  .annotation({Net_2005}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__OpaLP_vm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__OpaLPout_net;
	wire [0:0] tmpFB_0__OpaLPout_net;
	wire [0:0] tmpIO_0__OpaLPout_net;
	wire [0:0] tmpINTERRUPT_0__OpaLPout_net;
	electrical [0:0] tmpSIOVREF__OpaLPout_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("efdea9d7-dbde-4222-a75a-6960856938ef"),
		  ...
		  .input_buffer_sel(2'b00))
		OpaLPout
		 (.oe(tmpOE__OpaLPout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OpaLPout_net[0:0]}),
		  .analog({Net_2001}),
		  .io({tmpIO_0__OpaLPout_net[0:0]}),
		  .siovref(tmpSIOVREF__OpaLPout_net),
		  .interrupt({tmpINTERRUPT_0__OpaLPout_net[0:0]}),
		  .annotation({Net_2018}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__OpaLPout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
