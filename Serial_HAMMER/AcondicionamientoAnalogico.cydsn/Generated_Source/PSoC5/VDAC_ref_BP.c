...
#if (CY_PSOC5A)
    static uint8 VDAC_ref_BP_restoreVal = 0u;
#endif /* CY_PSOC5A */
...
{
    VDAC_ref_BP_CR0 = (VDAC_ref_BP_MODE_V );

    /* Set default data source */
    #if(VDAC_ref_BP_DEFAULT_DATA_SRC != 0 )
    ...
    #endif /* (VDAC_ref_BP_DEFAULT_DATA_SRC != 0 ) */

    /* Set default strobe mode */
    #if(VDAC_ref_BP_DEFAULT_STRB != 0)
        VDAC_ref_BP_Strobe |= VDAC_ref_BP_STRB_EN ;
    #endif/* (VDAC_ref_BP_DEFAULT_STRB != 0) */

    /* Set default range */
    VDAC_ref_BP_SetRange(VDAC_ref_BP_DEFAULT_RANGE); 
...
void VDAC_ref_BP_Enable(void) 
{
    ...
    #if (CY_PSOC5A)
        if(VDAC_ref_BP_restoreVal == 1u) 
        {
             VDAC_ref_BP_CR0 = VDAC_ref_BP_backup.data_value;
             VDAC_ref_BP_restoreVal = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
*
* Global variables:
*  VDAC_ref_BP_initVar: Is modified when this function is called for the 
...
void VDAC_ref_BP_Stop(void) 
{
    ...
    #if (CY_PSOC5A)
        VDAC_ref_BP_backup.data_value = VDAC_ref_BP_CR0;
        VDAC_ref_BP_CR0 = VDAC_ref_BP_CUR_MODE_OUT_OFF;
        VDAC_ref_BP_restoreVal = 1u;
    #endif /* CY_PSOC5A */
}
...
void VDAC_ref_BP_DacTrim(void) 
{
    ...
    mode = (uint8)((VDAC_ref_BP_CR0 & VDAC_ref_BP_RANGE_MASK) >> 2) + VDAC_ref_BP_TRIM_M7_1V_RNG_OFFSET;
