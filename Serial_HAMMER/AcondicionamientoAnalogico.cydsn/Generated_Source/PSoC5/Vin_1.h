...
#if !(CY_PSOC5A &&\
	 Vin_1__PORT == 15 && ((Vin_1__MASK & 0xC0) != 0))
...
void    Vin_1_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Vin_1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Vin_1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Vin_1_SetInterruptMode() function.
     *  @{
     */
        #define Vin_1_INTR_NONE      (uint16)(0x0000u)
        #define Vin_1_INTR_RISING    (uint16)(0x0001u)
        #define Vin_1_INTR_FALLING   (uint16)(0x0002u)
        #define Vin_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Vin_1_INTR_MASK      (0x01u) 
#endif /* (Vin_1__INTSTAT) */
...
/* SIO registers */
#if defined(Vin_1__SIO_CFG)
    #define Vin_1_SIO_HYST_EN        (* (reg8 *) Vin_1__SIO_HYST_EN)
    #define Vin_1_SIO_REG_HIFREQ     (* (reg8 *) Vin_1__SIO_REG_HIFREQ)
    #define Vin_1_SIO_CFG            (* (reg8 *) Vin_1__SIO_CFG)
    #define Vin_1_SIO_DIFF           (* (reg8 *) Vin_1__SIO_DIFF)
#endif /* (Vin_1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Vin_1_0_INTTYPE_REG 		(* (reg8 *) Vin_1__0__INTTYPE)
#endif /* (Vin_1__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Vin_1_H */
