...
void    In_p_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the In_p_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(In_p__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in In_p_SetInterruptMode() function.
     *  @{
     */
        #define In_p_INTR_NONE      (uint16)(0x0000u)
        #define In_p_INTR_RISING    (uint16)(0x0001u)
        #define In_p_INTR_FALLING   (uint16)(0x0002u)
        #define In_p_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define In_p_INTR_MASK      (0x01u) 
#endif /* (In_p__INTSTAT) */
...
/* SIO registers */
#if defined(In_p__SIO_CFG)
    #define In_p_SIO_HYST_EN        (* (reg8 *) In_p__SIO_HYST_EN)
    #define In_p_SIO_REG_HIFREQ     (* (reg8 *) In_p__SIO_REG_HIFREQ)
    #define In_p_SIO_CFG            (* (reg8 *) In_p__SIO_CFG)
    #define In_p_SIO_DIFF           (* (reg8 *) In_p__SIO_DIFF)
#endif /* (In_p__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define In_p_0_INTTYPE_REG 		(* (reg8 *) In_p__0__INTTYPE)
#endif /* (In_p__INTSTAT) */
