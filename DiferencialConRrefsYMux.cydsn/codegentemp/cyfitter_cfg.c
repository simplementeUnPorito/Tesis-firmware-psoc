...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000408u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000414u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800041Cu)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000424u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x4800042Cu)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000434u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AG, 0x70u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT1_AG, 0xA4u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AG, 0x04u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT15_AG, 0x3Du);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BG_CR0, 0x09u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC0_SW0, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC0_SW4, 0x40u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC0_SW8, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC1_SW0, 0x02u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DAC1_SW2, 0x02u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP1_MX, 0x0106u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0106u);
...
static uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_A__outerAddr[3] = {
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
	(uint8 CYXDATA *)CYREG_DSM0_SW0, 
};

static const uint8 CYCODE AMux_CYAMUXSIDE_A__outerMask[3] = {
	0x80u, 
	0x80u, 
	0x02u, 
};

static uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_A__innerAddr[2] = {
	(uint8 CYXDATA *)CYREG_DSM0_SW0, 
	(uint8 CYXDATA *)CY_AMUX_UNUSED, 
};

static const uint8 CYCODE AMux_CYAMUXSIDE_A__innerMask[2] = {
	0x80u, 
	0x00u, 
};

static const uint8 CYCODE AMux_CYAMUXSIDE_A__innerMap[3] = {
	0u, 
	0u, 
	1u, 
};

static uint8 AMux_CYAMUXSIDE_A__armsEnabled = 0u;
static uint8 AMux_CYAMUXSIDE_A__refCnt[] = {0u, 0u};
...
void AMux_CYAMUXSIDE_A_Set(uint8 channel)
{
	...
	if ((channel < 3u) && ((AMux_CYAMUXSIDE_A__armsEnabled & channelMask) == ((uint32)0u)))
	{
		AMux_CYAMUXSIDE_A__armsEnabled |= channelMask;
		*AMux_CYAMUXSIDE_A__outerAddr[channel] |= AMux_CYAMUXSIDE_A__outerMask[channel];
		i = AMux_CYAMUXSIDE_A__innerMap[channel];
		if (AMux_CYAMUXSIDE_A__refCnt[i] == 0u)
		{
			*AMux_CYAMUXSIDE_A__innerAddr[i] |= AMux_CYAMUXSIDE_A__innerMask[i];
		}
		AMux_CYAMUXSIDE_A__refCnt[i]++;
	}
}
...
void AMux_CYAMUXSIDE_A_Unset(uint8 channel)
{
	...
	if ((channel < 3u) && ((AMux_CYAMUXSIDE_A__armsEnabled & channelMask) != ((uint32)0u)))
	{
		AMux_CYAMUXSIDE_A__armsEnabled &= (uint8)~channelMask;
		*AMux_CYAMUXSIDE_A__outerAddr[channel] &= (uint8)~AMux_CYAMUXSIDE_A__outerMask[channel];
		i = AMux_CYAMUXSIDE_A__innerMap[channel];
		AMux_CYAMUXSIDE_A__refCnt[i]--;
		if (AMux_CYAMUXSIDE_A__refCnt[i] == 0)
		{
			*AMux_CYAMUXSIDE_A__innerAddr[i] &= (uint8)~AMux_CYAMUXSIDE_A__innerMask[i];
		}
	}
}
...
uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_B__addrTable[3] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_CYAMUXSIDE_B__maskTable[3] = {
	0x02u, 
	0x08u, 
	0x08u, 
};
