...
/*******************************************************************************
* Function Name: Clock_Wave_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_Start(void) 
{
    /* Set the bit to enable the clock. */
    Clock_Wave_CLKEN |= Clock_Wave_CLKEN_MASK;
	Clock_Wave_CLKSTBY |= Clock_Wave_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Clock_Wave_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    Clock_Wave_CLKEN &= (uint8)(~Clock_Wave_CLKEN_MASK);
	Clock_Wave_CLKSTBY &= (uint8)(~Clock_Wave_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Clock_Wave_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_StopBlock(void) 
{
    if ((Clock_Wave_CLKEN & Clock_Wave_CLKEN_MASK) != 0u)
    {
...
#if defined(Clock_Wave__CFG3)
        CLK_DIST_AMASK = Clock_Wave_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Clock_Wave_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Clock_Wave__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Clock_Wave_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Clock_Wave_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Clock_Wave_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        Clock_Wave_CLKSTBY &= (uint8)(~Clock_Wave_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: Clock_Wave_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = Clock_Wave_GetSourceRegister();
    uint16 oldDivider = Clock_Wave_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Clock_Wave_CLKEN & Clock_Wave_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Clock_Wave_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: Clock_Wave_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 Clock_Wave_GetDividerRegister(void) 
{
    return CY_GET_REG16(Clock_Wave_DIV_PTR);
}


/*******************************************************************************
* Function Name: Clock_Wave_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_SetModeRegister(uint8 modeBitMask) 
{
    Clock_Wave_MOD_SRC |= modeBitMask & (uint8)Clock_Wave_MODE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Wave_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_ClearModeRegister(uint8 modeBitMask) 
{
    Clock_Wave_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Clock_Wave_MODE_MASK));
}


/*******************************************************************************
* Function Name: Clock_Wave_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_Wave_GetModeRegister(void) 
{
    return Clock_Wave_MOD_SRC & (uint8)(Clock_Wave_MODE_MASK);
}


/*******************************************************************************
* Function Name: Clock_Wave_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = Clock_Wave_GetDividerRegister();
    uint8 oldSrc = Clock_Wave_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Clock_Wave_MOD_SRC |= CYCLK_SSS;
        Clock_Wave_MOD_SRC =
            (Clock_Wave_MOD_SRC & (uint8)(~Clock_Wave_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Clock_Wave_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_Wave_GetSourceRegister(void) 
{
    return Clock_Wave_MOD_SRC & Clock_Wave_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Clock_Wave_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void Clock_Wave_SetPhaseRegister(uint8 clkPhase) 
{
    Clock_Wave_PHASE = clkPhase & Clock_Wave_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Clock_Wave_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 Clock_Wave_GetPhaseRegister(void) 
{
    return Clock_Wave_PHASE & Clock_Wave_PHASE_MASK;
}
