...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000424u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AG, 0x94u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x1C20u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_SC2_SW6, 0x0402u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DAC0_SW4, 0x01u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW3, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW4, 0x02u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP0_MX, 0x0606u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_OPAMP1_MX, 0x26u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP2_MX, 0x0206u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_OPAMP3_MX, 0x16u);
