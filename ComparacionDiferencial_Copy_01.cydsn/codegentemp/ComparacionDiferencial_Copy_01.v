// ======================================================================
// ComparacionDiferencial_Copy_01.v generated from TopDesign.cysch
// 04/30/2026 at 22:20
...
// OpAmp_v1_90(Mode=0, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=OpaLP_p, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=OpaLP_p, CY_INSTANCE_SHORT_NAME=OpaLP_p, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=OpaLP_p, )
...
// PGA_v2_0(Gain=8, Power=3, VddaValue=5, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_p_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_p_1, CY_INSTANCE_SHORT_NAME=PGA_p_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PGA_p_1, )
module PGA_v2_0_6 (
    Vin,
    Vout,
    Vref);
...
// PGA_v2_0(Gain=8, Power=3, VddaValue=5, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_n_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_n_2, CY_INSTANCE_SHORT_NAME=PGA_n_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PGA_n_2, )
module PGA_v2_0_7 (
    Vin,
    Vout,
    Vref);
...
// PGA_v2_0(Gain=8, Power=3, VddaValue=5, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_p_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_p_2, CY_INSTANCE_SHORT_NAME=PGA_p_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PGA_p_2, )
module PGA_v2_0_8 (
    Vin,
    Vout,
    Vref);
...
module top ;
    ...
    OpAmp_v1_90_1 OpaLP_n (
        .Vminus(Net_1169),
        .Vout(Net_1172),
        .Vplus(Vcomun));
    defparam OpaLP_n.Mode = 0;
    ...
    OpAmp_v1_90_2 OpaLP_p (
        .Vminus(Net_1168),
        .Vout(Net_1170),
        .Vplus(Vcomun));
    defparam OpaLP_p.Mode = 0;
    ...
    OpAmp_v1_90_3 OpaBP_n (
        .Vminus(Net_1156),
        .Vout(Net_1090),
        .Vplus(Vcomun));
    defparam OpaBP_n.Mode = 0;

    OpAmp_v1_90_4 OpaBP_p (
        .Vminus(Net_1158),
        .Vout(Net_1132),
        .Vplus(Vcomun));
