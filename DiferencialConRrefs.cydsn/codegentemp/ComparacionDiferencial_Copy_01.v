...
module top ;
    ...
    VDAC8_v1_90_6 VDAC_p (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_1481));
    defparam VDAC_p.Data_Source = 0;
    defparam VDAC_p.Initial_Value = 100;
    ...
    VDAC8_v1_90_11 VDAC_n (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_1473));
    defparam VDAC_n.Data_Source = 0;
    defparam VDAC_n.Initial_Value = 100;
