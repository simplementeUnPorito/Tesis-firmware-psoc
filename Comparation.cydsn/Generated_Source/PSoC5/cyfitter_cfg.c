...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000624u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800062Cu)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000634u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x4800065Cu)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 8 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000664u)

/* PHUB_CFGMEM10 Address: CYREG_PHUB_CFGMEM10_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM10_VAL ((const uint8 CYFAR *)0x4800066Cu)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000670u)

/* PHUB_CFGMEM2 Address: CYREG_PHUB_CFGMEM2_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)0x48000674u)

/* PHUB_CFGMEM3 Address: CYREG_PHUB_CFGMEM3_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM3_VAL ((const uint8 CYFAR *)0x48000678u)

/* PHUB_CFGMEM4 Address: CYREG_PHUB_CFGMEM4_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM4_VAL ((const uint8 CYFAR *)0x4800067Cu)

/* PHUB_CFGMEM8 Address: CYREG_PHUB_CFGMEM8_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM8_VAL ((const uint8 CYFAR *)0x48000680u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT0_AMUX, 0x6010u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT1_AG, 0x14u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AG, 0xC0u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0xA4u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT5_AMUX, 0x8080u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC1_SW0, 0x04u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC1_SW6, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW0, 0x08u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC3_SW6, 0x02u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP1_SW4, 0x40u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_SAR0_SW2, 0x1004u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x02050105u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_OPAMP2_MX, 0x26u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP3_MX, 0x0405u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x92u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW2, 0x06u);
...
static uint8 CYXDATA * const CYCODE MuxIn_CYAMUXSIDE_A__outerAddr[2] = {
	(uint8 CYXDATA *)CYREG_CMP1_SW3, 
	(uint8 CYXDATA *)CYREG_DAC1_SW0, 
};

static const uint8 CYCODE MuxIn_CYAMUXSIDE_A__outerMask[2] = {
	0x40u, 
	0x02u, 
};

static uint8 CYXDATA * const CYCODE MuxIn_CYAMUXSIDE_A__innerAddr[1] = {
	(uint8 CYXDATA *)CYREG_PRT2_AG, 
};

static const uint8 CYCODE MuxIn_CYAMUXSIDE_A__innerMask[1] = {
	0x02u, 
};

static const uint8 CYCODE MuxIn_CYAMUXSIDE_A__innerMap[2] = {
	0u, 
	0u, 
};

static uint8 MuxIn_CYAMUXSIDE_A__armsEnabled = 0u;
static uint8 MuxIn_CYAMUXSIDE_A__refCnt[] = {0u};

/*******************************************************************************
* Function Name: MuxIn_CYAMUXSIDE_A_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MuxIn_CYAMUXSIDE_A_Set(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 2u) && ((MuxIn_CYAMUXSIDE_A__armsEnabled & channelMask) == ((uint32)0u)))
	{
		MuxIn_CYAMUXSIDE_A__armsEnabled |= channelMask;
		*MuxIn_CYAMUXSIDE_A__outerAddr[channel] |= MuxIn_CYAMUXSIDE_A__outerMask[channel];
		i = MuxIn_CYAMUXSIDE_A__innerMap[channel];
		if (MuxIn_CYAMUXSIDE_A__refCnt[i] == 0u)
		{
			*MuxIn_CYAMUXSIDE_A__innerAddr[i] |= MuxIn_CYAMUXSIDE_A__innerMask[i];
		}
		MuxIn_CYAMUXSIDE_A__refCnt[i]++;
	}
}

/*******************************************************************************
* Function Name: MuxIn_CYAMUXSIDE_A_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MuxIn_CYAMUXSIDE_A_Unset(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 2u) && ((MuxIn_CYAMUXSIDE_A__armsEnabled & channelMask) != ((uint32)0u)))
	{
		MuxIn_CYAMUXSIDE_A__armsEnabled &= (uint8)~channelMask;
		*MuxIn_CYAMUXSIDE_A__outerAddr[channel] &= (uint8)~MuxIn_CYAMUXSIDE_A__outerMask[channel];
		i = MuxIn_CYAMUXSIDE_A__innerMap[channel];
		MuxIn_CYAMUXSIDE_A__refCnt[i]--;
		if (MuxIn_CYAMUXSIDE_A__refCnt[i] == 0)
		{
			*MuxIn_CYAMUXSIDE_A__innerAddr[i] &= (uint8)~MuxIn_CYAMUXSIDE_A__innerMask[i];
		}
	}
}
...
uint8 CYXDATA * const CYCODE MuxIn_CYAMUXSIDE_B__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_PRT2_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_DAC0_SW0, (uint8 CYXDATA *)CYREG_PRT2_AG, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE MuxIn_CYAMUXSIDE_B__maskTable[4] = {
	0x01u, 0x00u, 
	0x01u, 0x01u, 
};

/*******************************************************************************
* Function Name: MuxIn_CYAMUXSIDE_B_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void MuxIn_CYAMUXSIDE_B_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*MuxIn_CYAMUXSIDE_B__addrTable[channel] |= MuxIn_CYAMUXSIDE_B__maskTable[channel];
		channel++;
		*MuxIn_CYAMUXSIDE_B__addrTable[channel] |= MuxIn_CYAMUXSIDE_B__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: MuxIn_CYAMUXSIDE_B_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void MuxIn_CYAMUXSIDE_B_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*MuxIn_CYAMUXSIDE_B__addrTable[channel] &= (uint8)~MuxIn_CYAMUXSIDE_B__maskTable[channel];
		channel++;
		*MuxIn_CYAMUXSIDE_B__addrTable[channel] &= (uint8)~MuxIn_CYAMUXSIDE_B__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE MuxOut_CYAMUXSIDE_A__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_SC1_SW8, (uint8 CYXDATA *)CYREG_PRT3_AMUX, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE MuxOut_CYAMUXSIDE_A__maskTable[4] = {
	0x08u, 0x02u, 
	0x42u, 0x00u, 
};

/*******************************************************************************
* Function Name: MuxOut_CYAMUXSIDE_A_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void MuxOut_CYAMUXSIDE_A_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*MuxOut_CYAMUXSIDE_A__addrTable[channel] |= MuxOut_CYAMUXSIDE_A__maskTable[channel];
		channel++;
		*MuxOut_CYAMUXSIDE_A__addrTable[channel] |= MuxOut_CYAMUXSIDE_A__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: MuxOut_CYAMUXSIDE_A_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void MuxOut_CYAMUXSIDE_A_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*MuxOut_CYAMUXSIDE_A__addrTable[channel] &= (uint8)~MuxOut_CYAMUXSIDE_A__maskTable[channel];
		channel++;
		*MuxOut_CYAMUXSIDE_A__addrTable[channel] &= (uint8)~MuxOut_CYAMUXSIDE_A__maskTable[channel];
	}
}

static uint8 CYXDATA * const CYCODE MuxOut_CYAMUXSIDE_B__outerAddr[2] = {
	(uint8 CYXDATA *)CYREG_SC3_SW8, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
};

static const uint8 CYCODE MuxOut_CYAMUXSIDE_B__outerMask[2] = {
	0x10u, 
	0x01u, 
};

static uint8 CYXDATA * const CYCODE MuxOut_CYAMUXSIDE_B__innerAddr[1] = {
	(uint8 CYXDATA *)CYREG_PRT3_AG, 
};

static const uint8 CYCODE MuxOut_CYAMUXSIDE_B__innerMask[1] = {
	0x01u, 
};

static const uint8 CYCODE MuxOut_CYAMUXSIDE_B__innerMap[2] = {
	0u, 
	0u, 
};

static uint8 MuxOut_CYAMUXSIDE_B__armsEnabled = 0u;
static uint8 MuxOut_CYAMUXSIDE_B__refCnt[] = {0u};

/*******************************************************************************
* Function Name: MuxOut_CYAMUXSIDE_B_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void MuxOut_CYAMUXSIDE_B_Set(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 2u) && ((MuxOut_CYAMUXSIDE_B__armsEnabled & channelMask) == ((uint32)0u)))
	{
		MuxOut_CYAMUXSIDE_B__armsEnabled |= channelMask;
		*MuxOut_CYAMUXSIDE_B__outerAddr[channel] |= MuxOut_CYAMUXSIDE_B__outerMask[channel];
		i = MuxOut_CYAMUXSIDE_B__innerMap[channel];
		if (MuxOut_CYAMUXSIDE_B__refCnt[i] == 0u)
		{
			*MuxOut_CYAMUXSIDE_B__innerAddr[i] |= MuxOut_CYAMUXSIDE_B__innerMask[i];
		}
		MuxOut_CYAMUXSIDE_B__refCnt[i]++;
	}
}

/*******************************************************************************
* Function Name: MuxOut_CYAMUXSIDE_B_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void MuxOut_CYAMUXSIDE_B_Unset(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 2u) && ((MuxOut_CYAMUXSIDE_B__armsEnabled & channelMask) != ((uint32)0u)))
	{
		MuxOut_CYAMUXSIDE_B__armsEnabled &= (uint8)~channelMask;
		*MuxOut_CYAMUXSIDE_B__outerAddr[channel] &= (uint8)~MuxOut_CYAMUXSIDE_B__outerMask[channel];
		i = MuxOut_CYAMUXSIDE_B__innerMap[channel];
		MuxOut_CYAMUXSIDE_B__refCnt[i]--;
		if (MuxOut_CYAMUXSIDE_B__refCnt[i] == 0)
		{
			*MuxOut_CYAMUXSIDE_B__innerAddr[i] &= (uint8)~MuxOut_CYAMUXSIDE_B__innerMask[i];
		}
	}
}
