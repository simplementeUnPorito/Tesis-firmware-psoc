...
module top ;
    ...
    OpAmp_v1_90_13 OPAref (
        .Vminus(Net_5207),
        .Vout(Net_4661),
        .Vplus(Net_4204));
    defparam OPAref.Mode = 1;

    Analog_LPF_v1_0_14 LPF_2 (
        .Vin(Net_5206),
        .Vout(Net_4204));
