...
module top ;
    ...
    Analog_LPF_v1_0_6 LPF_2 (
        .Vin(Net_5206),
        .Vout(Net_4204));

    OpAmp_v1_90_7 OPAref (
        .Vminus(Net_5207),
        .Vout(Net_4661),
        .Vplus(Net_4204));
