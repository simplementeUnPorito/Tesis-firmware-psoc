...
#if !defined(CY_VDAC8_VDAC_ref_LP_H) 
#define CY_VDAC8_VDAC_ref_LP_H
...
#define VDAC_ref_LP_RANGE_1V       0x00u
#define VDAC_ref_LP_RANGE_4V       0x04u
...
***************************************/
 ...
 /* Default DAC range */
#define VDAC_ref_LP_DEFAULT_RANGE    4u
 /* Default DAC speed */
#define VDAC_ref_LP_DEFAULT_SPEED    2u
 /* Default Control */
#define VDAC_ref_LP_DEFAULT_CNTL      0x00u
/* Default Strobe mode */
#define VDAC_ref_LP_DEFAULT_STRB     0u
 /* Initial DAC value */
#define VDAC_ref_LP_DEFAULT_DATA     156u
 /* Default Data Source */
#define VDAC_ref_LP_DEFAULT_DATA_SRC 0u
...
/* Power manager */
#define VDAC_ref_LP_PWRMGR_REG         (* (reg8 *) VDAC_ref_LP_viDAC8__PM_ACT_CFG )
#define VDAC_ref_LP_PWRMGR_PTR         (  (reg8 *) VDAC_ref_LP_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC_ref_LP_STBY_PWRMGR_REG    (* (reg8 *) VDAC_ref_LP_viDAC8__PM_STBY_CFG )
#define VDAC_ref_LP_STBY_PWRMGR_PTR    (  (reg8 *) VDAC_ref_LP_viDAC8__PM_STBY_CFG )
...
/* Power manager */
#define VDAC_ref_LP_PWRMGR      (* (reg8 *) VDAC_ref_LP_viDAC8__PM_ACT_CFG )
  /* Standby Power manager */
#define VDAC_ref_LP_STBY_PWRMGR (* (reg8 *) VDAC_ref_LP_viDAC8__PM_STBY_CFG )
...
#define VDAC_ref_LP_ACT_PWR_EN   VDAC_ref_LP_viDAC8__PM_ACT_MSK
  /* Standby Power enable mask */
#define VDAC_ref_LP_STBY_PWR_EN  VDAC_ref_LP_viDAC8__PM_STBY_MSK
...
*******************************************************************************/
#define VDAC_ref_LP_TRIM_M7_1V_RNG_OFFSET  0x06u
#define VDAC_ref_LP_TRIM_M8_4V_RNG_OFFSET  0x07u
/*Constatnt to set DAC in current mode and turnoff output */
#define VDAC_ref_LP_CUR_MODE_OUT_OFF       0x1Eu 
#define VDAC_ref_LP_DAC_TRIM_BASE          (VDAC_ref_LP_viDAC8__TRIM__M1)

#endif /* CY_VDAC8_VDAC_ref_LP_H  */
