...
#define CAL_TARGET_COUNTS_GEO_BP   0L
...
#define CAL_TOL_COUNTS_GEO_BP      5243L
...
#define CAL_DEADBAND_COUNTS_GEO_BP 5243L

/* ===== Asentamiento: muestras descartadas tras escribir el VDAC, antes de
 * empezar a promediar (a ~3 kSPS). GEO_BP ve el asentamiento acumulado de
 * GEO_PGA, por eso su descarte es mas largo. No cambia con el rediseño de
 * promediado. */
#define CAL_SETTLE_SAMPLES_GEO_BP        15000u
#define CAL_VERIFY_SETTLE_SAMPLES_GEO_BP 24000u
...
#define CAL_AVG_WINDOW_COUNT_GEO_BP   16u   /* piso 1024 muestras (~341ms) */
#define CAL_AVG_MAX_SAMPLES_GEO_BP    2048u /* techo ~683ms */
...
#define CAL_VERIFY_AVG_MAX_SAMPLES_GEO_BP 4096u /* ~1.4s */
...
#define CAL_REALCHECK_DISCARD_SAMPLES_GEO_BP       1500u /* settle al cambiar AMux_ADC */
#define CAL_REALCHECK_NUDGE_DISCARD_SAMPLES_GEO_BP  200u /* settle tras un nudge de +-1 LSB */
#define CAL_REALCHECK_AVG_N_GEO_BP              64u
#define CAL_REALCHECK_AVG_WINDOW_COUNT_GEO_BP   64u   /* piso 4096 muestras (~1.4s) */
#define CAL_REALCHECK_AVG_MAX_SAMPLES_GEO_BP    8192u /* techo ~2.7s */
