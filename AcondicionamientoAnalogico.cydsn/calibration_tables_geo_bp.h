...
/* ===== Asentamiento: tiempo simulado 100 us, convertido a muestras con
 ...
 * entre VDAC_ref_BP y el punto de medicion (AMux_ADC=1) — ajustar con
 * osciloscopio. */
#define CAL_PI_KP_NUM_GEO_BP        1L
#define CAL_PI_KP_DIV_GEO_BP        2000L
#define CAL_PI_KI_NUM_GEO_BP        1L
#define CAL_PI_KI_DIV_GEO_BP        16000L
#define CAL_PI_LSB_COUNTS_GEO_BP    839L
#define CAL_PI_MAX_SAMPLES_GEO_BP   6000u
