 ...
 * empezar a promediar (a ~3 kSPS). GEO_ADDER ve el asentamiento acumulado de
 * GEO_PGA+GEO_BP. No cambia con el rediseño de promediado. */
#define CAL_SETTLE_SAMPLES_GEO_ADDER        8000u
#define CAL_VERIFY_SETTLE_SAMPLES_GEO_ADDER 12000u
...
#define CAL_REALCHECK_DISCARD_SAMPLES_GEO_ADDER       1500u /* settle al cambiar AMux_ADC */
#define CAL_REALCHECK_NUDGE_DISCARD_SAMPLES_GEO_ADDER  200u /* settle tras un nudge de +-1 LSB */
