...
#if !defined(CY_IDAC8_VDAC_ref_BP_H)  
#define CY_IDAC8_VDAC_ref_BP_H
...
typedef struct
{
    ...
    {
        uint8 DACCR0Reg;
    }   VDAC_ref_BP_LOWPOWER_BACKUP_STRUCT;
#endif /* CY_PSOC5A */
...
#define VDAC_ref_BP_RANGE_32uA             (0x00u)
#define VDAC_ref_BP_RANGE_255uA            (0x04u)
#define VDAC_ref_BP_RANGE_2mA              (0x08u)

/* SetPolarity constants */
#define VDAC_ref_BP_SOURCE                 (0x00u)
#define VDAC_ref_BP_SINK                   (0x04u)
#define VDAC_ref_BP_HARDWARE_CONTROLLED    (0x02u)
...
#define VDAC_ref_BP_PWRMGR_REG      (* (reg8 *) VDAC_ref_BP_viDAC8__PM_ACT_CFG )  /* Power manager */
#define VDAC_ref_BP_PWRMGR_PTR      (  (reg8 *) VDAC_ref_BP_viDAC8__PM_ACT_CFG )  /* Power manager */
#define VDAC_ref_BP_STBY_PWRMGR_REG (* (reg8 *) VDAC_ref_BP_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
#define VDAC_ref_BP_STBY_PWRMGR_PTR (  (reg8 *) VDAC_ref_BP_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
...
#define VDAC_ref_BP_PWRMGR      (* (reg8 *) VDAC_ref_BP_viDAC8__PM_ACT_CFG )  /* Power manager */
#define VDAC_ref_BP_STBY_PWRMGR (* (reg8 *) VDAC_ref_BP_viDAC8__PM_STBY_CFG )  /* Standby Power manager */
...
#define VDAC_ref_BP_RANGE_2        (0x08u)
#define VDAC_ref_BP_RANGE_3        (0x0Cu)
...
#define VDAC_ref_BP_IDIR_SRC_MASK  (0x08u)
#define VDAC_ref_BP_IDIR_SRC_REG   (0x00u)
#define VDAC_ref_BP_IDIR_SRC_UDB   (0x08u)

/* Bit Field  DAC_I_DIR                  */
/* Register control of current direction      */
#define VDAC_ref_BP_IDIR_MASK      (0x04u)
#define VDAC_ref_BP_IDIR_SRC       (0x00u)
#define VDAC_ref_BP_IDIR_SINK      (0x04u)

/* Bit Field  DAC_MX_IOFF_SRC                  */
/* Selects source of IOFF control, reg or UDB  */
#define VDAC_ref_BP_IDIR_CTL_MASK  (0x02u)
#define VDAC_ref_BP_IDIR_CTL_REG   (0x00u)
#define VDAC_ref_BP_IDIR_CTL_UDB   (0x02u)

/* Bit Field  DAC_MX_IOFF                   */
/* Register control of IDAC                 */
/* Only valid if IOFF CTL is set to Reg     */
#define VDAC_ref_BP_I_OFF_MASK     (0x01u)
#define VDAC_ref_BP_I_OFF          (0x00u)
#define VDAC_ref_BP_I_ON           (0x01u)
...
#define VDAC_ref_BP_ACT_PWR_EN   VDAC_ref_BP_viDAC8__PM_ACT_MSK  /* Power enable mask */ 
#define VDAC_ref_BP_STBY_PWR_EN  VDAC_ref_BP_viDAC8__PM_STBY_MSK  /* Standby Power enable mask */ 

#endif /* CY_IDAC8_VDAC_ref_BP_H */
