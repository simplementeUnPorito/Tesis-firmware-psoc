...
extern void AMux_Signal_Set(uint8 channel);
extern void AMux_Signal_Unset(uint8 channel);
extern void AMux_Vref_Set(uint8 channel);
extern void AMux_Vref_Unset(uint8 channel);
