...
*
* \funcusage
*  \snippet Vin_2_SUT.c usage_Vin_2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin_2_SUT.c usage_Vin_2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin_2_SUT.c usage_Vin_2_Read  
*******************************************************************************/
...
* preferred Vin_2_Read() API because the 
* Vin_2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin_2_SUT.c usage_Vin_2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin_2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin_2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin_2_0_INTR       (First pin in the list)
    *  - Vin_2_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin_2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin_2_SUT.c usage_Vin_2_SetInterruptMode
    *******************************************************************************/
    void Vin_2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin_2_0_INTR) != 0u) 
		{ 
			 Vin_2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin_2_SUT.c usage_Vin_2_ClearInterrupt
    *******************************************************************************/
