...
*
* \funcusage
*  \snippet Vin_4_SUT.c usage_Vin_4_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin_4_SUT.c usage_Vin_4_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin_4_SUT.c usage_Vin_4_Read  
*******************************************************************************/
...
* preferred Vin_4_Read() API because the 
* Vin_4_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin_4_SUT.c usage_Vin_4_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin_4_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin_4_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin_4_0_INTR       (First pin in the list)
    *  - Vin_4_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin_4_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin_4_SUT.c usage_Vin_4_SetInterruptMode
    *******************************************************************************/
    void Vin_4_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin_4_0_INTR) != 0u) 
		{ 
			 Vin_4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin_4_SUT.c usage_Vin_4_ClearInterrupt
    *******************************************************************************/
