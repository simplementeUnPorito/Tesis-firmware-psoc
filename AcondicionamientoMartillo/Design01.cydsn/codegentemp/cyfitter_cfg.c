...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800008Cu)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000094u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800009Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480000A4u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480000ACu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW0, 0x40u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW4, 0x20u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC2_SW8, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC3_SW3, 0x02u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP3_MX, 0x0115u);
